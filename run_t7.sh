...
arduino-cli compile -b leat-echostar-terminals:stm32:EchoT7 5_Sensors_KX023 $ADDITIONAL_FLAGS
T7_RESULT_5=$?

echo "6_GNSS_MicroNMEA"
arduino-cli compile -b leat-echostar-terminals:stm32:EchoT7 6_GNSS_MicroNMEA $ADDITIONAL_FLAGS
T7_RESULT_6=$?
...
if [ $T7_RESULT_5 -eq 0 ]
then
	echo "Term 7 - 5_Sensors_KX023: PASS"
	COUNTER=$((COUNTER+1))
else
	echo "Term 7 - 5_Sensors_KX023: FAIL"
fi
TOTAL=$((TOTAL+1))

if [ $T7_RESULT_6 -eq 0 ]
then
	echo "Term 7 - 6_GNSS_MicroNMEA: PASS"
	COUNTER=$((COUNTER+1))
else
	echo "Term 7 - 6_GNSS_MicroNMEA: FAIL"
fi
TOTAL=$((TOTAL+1))
