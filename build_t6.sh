...
arduino-cli compile -b leat-echostar-terminals:stm32:EchoT6 6_Sensors_KX023 $ADDITIONAL_FLAGS
T6_RESULT_6=$?

echo "7_GNSS_MicroNMEA"
arduino-cli compile -b leat-echostar-terminals:stm32:EchoT6 7_GNSS_MicroNMEA $ADDITIONAL_FLAGS
T6_RESULT_7=$?
...
if [ $T6_RESULT_6 -eq 0 ]
then
	echo "Term 6 - 6_Sensors_KX023: PASS"
	COUNTER=$((COUNTER+1))
else
	echo "Term 6 - 6_Sensors_KX023: FAIL"
fi
TOTAL=$((TOTAL+1))

if [ $T6_RESULT_7 -eq 0 ]
then
	echo "Term 6 - 7_GNSS_MicroNMEA: PASS"
	COUNTER=$((COUNTER+1))
else
	echo "Term 6 - 7_GNSS_MicroNMEA: FAIL"
fi
TOTAL=$((TOTAL+1))
